...
public class Game implements Runnable
{
    ...
    public void draw(Graphics g)
    {
        ...
        g.fillRect(0, 275, 120, 50);
        g.fillRect(75, 275, 50, 250);
        g.fillRect(75, 475, 250, 50);
        g.fillRect(275, 175, 50, 300);
        g.fillRect(275, 175, 200, 50);
        g.fillRect(425, 175, 50, 290);
        g.fillRect(425, 415, 200, 50);
