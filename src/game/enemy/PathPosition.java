 ...
 * on, the segment that the object is in, and the percentage across that
 * segment.
 *
 * @author basilvetas
 * @date 3/27/13
...
public class PathPosition {
     ...
     * @param path
     */
    PathPosition(List<Coordinate> points) {	// Initializes variables
    ...
    /**
     * Returns true if this path position is at the end of the path.
     *
    ...
    /**
     * Returns a coordinate object containing the (x, y) location of the current
     * path position. The path position is converted to its (x, y)
     * representation, a coordinate object is built containing the (x, y)
     * location, and the coordinate is returned.
     *
     * @return A Coordinate object containing the (x, y) location of this
     * position
     */
    public Coordinate getCoordinate() {
        ...
        ballX = startX + (int) (dX * percentage);
        ballY = startY + (int) (dY * percentage);
    ...
    /**
     * This method advances this path position by the specified number of
     * Cartesian units. (Pythagorean's theorem is used internally help with the
     * computation.) If the specified distance would cause the position to pass
     * the end of the path, the current position is stopped at the end of the
     * path.
     *
